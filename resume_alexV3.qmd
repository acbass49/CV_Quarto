...
<!-- CONTACT INFO -->
\begin{center}acbass49@gmail.com ∙ \href{https://github.com/acbass49}{Github} ∙ \href{https://www.linkedin.com/in/alex-bass-4a7465161/}{LinkedIn} ∙ \href{https://alexbass.me}{Blog}
\end{center}
\vspace{5pt}
...
\end{large}
\vspace{-0.16cm}
* Worked on **Meta's marketing decision science team** focused on public affairs and policy elites. 
* Analyzed on-platform experiment data and marketing campaign survey data; built tools around diff-in-d and funnel analysis.
\vspace{0pt}
...
\end{large}
\vspace{-0.1cm}
[*survey_tools*](https://github.com/acbass49/survey_tools) - Creator and Maintainer of an open-source **Python package for survey reseachers** with convenient functions for weighted crosstabs, recoding variables, and weighting surveys. This package is available on [github](https://github.com/acbass49/survey_tools) and [PyPI](https://pypi.org/project/survey-tools/).

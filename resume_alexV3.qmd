...
<!-- CONTACT INFO -->
\begin{center}\href{mailto::acbass9@gmail.com}{acbass49@gmail.com} ∙ \href{https://github.com/acbass49}{Github} ∙ \href{https://www.linkedin.com/in/alex-bass-4a7465161/}{LinkedIn} ∙ \href{https://alexbass.me/projects}{Projects}
\end{center}
\vspace{5pt}
...
\begin{large}{\bf EXPERIENCE}
  ...
  \begin{multicols}{2}
    \begin{flushleft}{
      ...
      \bf \href{https://about.meta.com}{Crystal Equations [at] Meta}}\\
      \hspace{11 mm}
      \textit{Data Scientist, L5 (contract)}
    \end{flushleft}
    \begin{flushright}
    \begin{small}(10mth)\end{small} April 2024-January 2025\\
    New York, NY
    \end{flushright}
  \end{multicols}
\end{large}
\vspace{-0.16cm}
* **Analyzed ad impact via A/B tests and causal inference techniques for latest Meta AI campaigns in Europe and Teen Instagram accounts in the US**. 
* Used on-platform A/B experiment data and marketing campaign survey data to measure and track user sentiment on a dashboard I built with a DE.
\vspace{0pt}

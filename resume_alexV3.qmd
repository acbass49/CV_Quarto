...
\end{large}
\vspace{-0.16cm}
* Built tools on **Meta's marketing decision science team** analyzing ads for public affairs and policy elites. 
* Analyzed on-platform experiment data and marketing campaign survey data; Keywords: diff-in-diff, funnel analysis.
\vspace{0pt}

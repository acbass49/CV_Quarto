...
{\bf SELECTED PROJECT}
  ...
  \hrule
  \begin{multicols}{2}
    \begin{flushleft}\textit{\href{https://alexbass.me/projects/election_model_2024/}{Live Dashboard of 2024 US Presidential Election}}\end{flushleft}
    \begin{flushright}April 2020\end{flushright}
  \end{multicols}
  \vspace{-0.17cm}
\end{large}
* Estimate daily a heirarchal bayesian regression model to generate candidate probabilities of election outcomes using latest quality polling data
* Created a daily updated data pipeline using Python and Github Actions fed into Python visualizations in a Live Quarto Dashboard

...
\begin{large}
  ...
  \begin{multicols}{2}
    \begin{flushleft}
      ...
      \hspace{1 mm} {\bf University of Virgina}\\
...
\end{large}
\vspace{-0.16cm}
* **Led team (5 DS) to build a bayesian multi-touch attribution (PYMC) product measuring effectiveness of ad campaigns on brand lift surveys.** Outputing lift curves, channel ROI tables, and channel contribution charts for client delivery.

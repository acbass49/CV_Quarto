...
\begin{large}{\bf EXPERIENCE}
  ...
  \begin{multicols}{2}
    \begin{flushleft}{
      ...
      \hspace{11 mm}
      \textit{Data Scientist, Public Affairs (Contract)}
    \end{flushleft}
    \begin{flushright}
...
\end{large}
\vspace{-0.16cm}
* Used causal inference methods to measure effectiveness of Meta's ad campaigns (e.g. diff-in-diff)
\vspace{7pt}
...
**Selected Coursework** - Deep Learning, Bayesian Machine Learning, Big Data Systems with Spark, Linear Models for Data Science, Statistical Learning, Data Engineering, Linear Algebra, Econometrics I & II, Data Visualization, Data Engineering

...
\begin{large}
  ...
  \end{multicols}
  \vspace{-0.25cm}
  \textit{\href{https://archive.org/}{Internet Archive} Sponsored Capstone: \href{https://github.com/acbass49/wiki2ia}{Entity Resolution Matching Wikipedia Citations to Internet Archive API}}
\end{large}

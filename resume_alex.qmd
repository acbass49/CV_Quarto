...
\begin{large}
  ...
  \end{multicols}
  \vspace{-0.25cm}
  \textit{Capstone: Political Message Detection and Likeability in Films(n=1000 survey)}
\end{large}
\vspace{3pt}
...
**Selected Coursework** - Deep Learning, Bayesian Machine Learning, Big Data Systems, Linear Models for Data Science, Statistical Learning, Data Engineering, Linear Algebra, Econometrics I & II, Data Visualization, Programming in Python
